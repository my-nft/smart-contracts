...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return string(abi.encodePacked(_baseURI, ipfs[tokenId], "")); // to use ipfs id
...
contract NonFungibleToken is Context, AccessControl, ERC721 {
  ...
  //  bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
   ...
   // mapping (address => bool) public whitelists;
     ...
     */
    function mint(address to, string memory ipfsId) public virtual {
        ...
        require(balanceOf(to) <= _maxPerWallet, "Max NFTs reached by wallet");
    }
